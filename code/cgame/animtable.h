...
stringID_table_t vmAnimTable[MAX_VIEWMODEL_ANIMATIONS + 1] = {
	...
	ENUM2STRING(VM_FIRE),
	ENUM2STRING(VM_FIRE_THERMAL),
	ENUM2STRING(VM_FIRE_DETPACK),
	ENUM2STRING(VM_FIRE_RAILDET),
	...
	ENUM2STRING(VM_TOSS_LEFT),
	ENUM2STRING(VM_TOSS_RIGHT),
	...
	ENUM2STRING(VM_F2HANDEDLIGHTNING_START),
	ENUM2STRING(VM_F2HANDEDLIGHTNING_HOLD),
	ENUM2STRING(VM_F2HANDEDLIGHTNING_RELEASE),
	ENUM2STRING(VM_FDRAIN),
	ENUM2STRING(VM_FDRAIN_START),
	ENUM2STRING(VM_FDRAIN_HOLD),
	ENUM2STRING(VM_FDRAIN_RELEASE),
	ENUM2STRING(VM_FDRAIN_GRAB_START),
	ENUM2STRING(VM_FDRAIN_GRAB_HOLD),
	ENUM2STRING(VM_FDRAIN_GRAB_END),
	ENUM2STRING(VM_FDRAIN_GRABBED),
	ENUM2STRING(VM_FORCE_ABSORB),
	ENUM2STRING(VM_FORCE_ABSORB_START),
	ENUM2STRING(VM_FORCE_ABSORB_END),
	ENUM2STRING(VM_FORCE_PROTECT),*/
