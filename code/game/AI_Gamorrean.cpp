...
/*
-------------------------
NPC_Gamorrean_Precache
-------------------------
*/
void NPC_Gamorrean_Precache(void)
{
	int i;
	for ( i = 1; i < 5; i ++ )
	{
...
void Gamorrean_ClearTimers(gentity_t *ent)
{
...
void NPC_Gamorrean_PlayConfusionSound(gentity_t *self)
...
void NPC_Gamorrean_Pain(gentity_t *self, gentity_t *inflictor, gentity_t *other, vec3_t point, int damage, int mod)
{
...
/*
-------------------------
Gamorrean_HoldPosition
-------------------------
*/

static void Gamorrean_HoldPosition(void)
{
...
static qboolean Gamorrean_Move(void)
{
...
/*
-------------------------
NPC_BSGamorrean_Patrol
-------------------------
*/

void NPC_BSGamorrean_Patrol(void)
				...
				if ( alertEvent >= 0 )//&& level.alertEvents[alertEvent].ID != NPCInfo->lastAlertID )
				{
					...
					if ( level.alertEvents[alertEvent].level == AEL_DISCOVERED )
					{
						...
						{//an enemy
							...
							TIMER_Set( NPC, "attackDelay", Q_irand( 500, 500 ) );
						}
					}
					else
...
/*
-------------------------
NPC_BSGamorrean_Attack
-------------------------
*/

void NPC_BSGamorrean_Attack(void)
{
// IN PAIN
//---------
...
void NPC_BSGamorrean_Default( void )
{
	...
	if (G_GamorreanAttackAnimDamage(NPC))
	{
		Gamorrean_AxeTrace();
	}
