		...
		else
		{
			...
			else
			{
				...
				case WP_RAIL_DETONATOR:
					if (weaponBusy)
					{
						PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONREADY_RD, SETANIM_FLAG_NORMAL);
					}
					else
					{
						PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONIDLE_RD, SETANIM_FLAG_NORMAL);
					}
					break;
...
int PM_GetTurnAnim( gentity_t *gent, int anim )
{
	...
	case BOTH_ATTACK_RD:		//# Attack with rail detonator
