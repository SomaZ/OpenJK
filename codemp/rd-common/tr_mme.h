...
void MME_AccumClearSSE( void* QRESTRICT w, const void* QRESTRICT r, short int mul, int count );
void MME_AccumAddSSE( void* QRESTRICT w, const void* QRESTRICT r, short int mul, int count );
...
extern QINLINE byte * R_MME_BlurOverlapBuf( mmeBlurBlock_t *block );
